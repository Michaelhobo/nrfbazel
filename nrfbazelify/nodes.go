...
func (l *LibraryNode) ChangeLabel(label *bazel.Label) {
  l.label = label
}
...
func (g *GroupNode) ChangeLabel(label *bazel.Label) {
  g.label = label
}
...
// OverrideNode is a node generated by include_overrides.
...
func (o *OverrideNode) ChangeLabel(label *bazel.Label) {
  o.label = label
}
...
func (r *RemapNode) ChangeLabel(label *bazel.Label) {
  r.label = label
}
